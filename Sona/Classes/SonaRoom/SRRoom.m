        ...
        dispatch_async([self syncQueue], ^{
            ...
            self.enterDisposable =  [[SREnterRoomRequestSignal enterRoomWithModel:model] subscribeNext:^(SNConfigModel *configModel) {
                ...
                dispatch_async([self syncQueue], ^{
                    ...
                    RACSignal *innerSignal = [[self attachConfigModelWithModel:configModel] flattenMap:^__kindof RACSignal * _Nullable(SNConfigModel *configModel) {
                        @strongify(self)
                        return [[self createSdkWithModel:configModel] flattenMap:^__kindof RACSignal * _Nullable(id  _Nullable value) {
                            @strongify(self)
